...
const ForgetPassword = () => {
    ...
    return (
        <div className="bg-yellow-400 h-screen relative p-3">
            ...
            <i onClick={()=>navigate(-1)} className="ri-arrow-left-line font-bold text-xl rounded-full absolute top-2 right-2 bg-white px-1"></i>
            <h2 className="text-3xl font-bold mt-6 mb-2">Forgot Password?</h2>
            <h2 className="text-3xl font-bold text-center">Don't worry....</h2>
            <img className="w-1/2 block mx-auto my-10" src="/images/pass-forget.webp" alt="" />
