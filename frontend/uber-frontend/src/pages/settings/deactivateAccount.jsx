const DeactivateAccount = ()=>{
    return (
        <div className="p-3">
            ...
            <textarea name="" className="bg-zinc-200 w-full rounded-lg mt-8 font-semibold p-3" placeholder="Enter the reason..." rows="4" id=""></textarea>
            <button className="border-red-400 rounded-lg border-3 p-3 w-[90%] text-red-400 text-xl font-bold absolute bottom-4 left-[5%]">Deactivate Account</button>
        </div>
    );
}
